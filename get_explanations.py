...
def main(args):
    ...
    if not args.dry_run:
        ...
        if 'nonDP' not in args.clipping_mode:
            ...
            variances_dir = f'attack_data/variances_{args.data}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            norms_l1_dir = f'attack_data/norms_l1_{args.data}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            norms_l2_dir = f'attack_data/norms_l2_{args.data}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            norms_linf_dir = f'attack_data/norms_linf_{args.data}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            deltas_dir = f'attack_data/deltas_{args.data}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
