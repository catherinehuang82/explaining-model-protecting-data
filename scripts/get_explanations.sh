...
conda run -n cnn2 python3 get_explanations.py --total_data_examples 20000 --explanation_type $1 --experiment_no $2 --clipping_mode $3 --epsilon $4 --epochs $5 --data $6 --model $7